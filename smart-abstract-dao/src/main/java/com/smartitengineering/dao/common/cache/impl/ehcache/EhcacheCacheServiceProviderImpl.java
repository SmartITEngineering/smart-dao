...
public class EhcacheCacheServiceProviderImpl<Key, Value>
    ...
    public void putToCache(Key key,
        ...
        try {
            ...
            long milliSeconds = expiryDateTime.getTime() - System.
                currentTimeMillis();
    ...
    public Map getStats() {
        ...
        if (mCache != null) {
            ...
            if (cacheStatistics != null) {
                eStatsMap.put("Associated Cache Name", cacheStatistics.
                    getAssociatedCacheName());
                eStatsMap.put("Average Get Time", String.valueOf(
                    cacheStatistics.getAverageGetTime()));
                eStatsMap.put("Cache Hits", String.valueOf(cacheStatistics.
                    getCacheHits()));
                eStatsMap.put("Cache Misses", String.valueOf(cacheStatistics.
                    getCacheMisses()));
                eStatsMap.put("Eviction Count", String.valueOf(cacheStatistics.
                    getEvictionCount()));
                eStatsMap.put("In Memory Hits", String.valueOf(cacheStatistics.
                    getInMemoryHits()));
                eStatsMap.put("On Disk Hits", String.valueOf(cacheStatistics.
                    getOnDiskHits()));
                eStatsMap.put("Object Count", String.valueOf(cacheStatistics.
                    getObjectCount()));
